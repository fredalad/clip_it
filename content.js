...
// --- Add a translucent floating status box ---
...
// --- Throttled clipping logic with live feedback ---
async function throttleClipping(coupons, headers) {
  ...
  for (let i = 0; i < coupons.length; i++) {
    ...
    try {
      const res = await fetch("https://www.marianos.com/atlas/v1/savings-coupons/v1/clip-unclip", {
        method: 'POST',
        credentials: 'include',
        headers: clipHeaders,
        body: body
